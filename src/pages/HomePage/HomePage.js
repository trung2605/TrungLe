...
const HomePage = () => {
  return (
    <div className="home-page">
      ...
      <section className="py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="text-gray-600 dark:text-gray-400">Kết nối với tôi:</span>
      ...
      {/* Quick Stats Section */}
      <section className="py-16 bg-gray-50 dark:bg-gray-800/50 rounded-2xl my-16">
        <motion.div
        ...
        >
          <div>
            <div className="text-3xl lg:text-4xl font-bold text-blue-600 dark:text-blue-400">10+</div>
            <div className="text-gray-600 dark:text-gray-400 mt-2">Dự án</div>
          </div>
          <div>
            <div className="text-3xl lg:text-4xl font-bold text-purple-600 dark:text-purple-400">5+</div>
            <div className="text-gray-600 dark:text-gray-400 mt-2">Chứng chỉ</div>
          </div>
          <div>
            <div className="text-3xl lg:text-4xl font-bold text-green-600 dark:text-green-400">15+</div>
            <div className="text-gray-600 dark:text-gray-400 mt-2">Kỹ năng</div>
          </div>
          <div>
            <div className="text-3xl lg:text-4xl font-bold text-orange-600 dark:text-orange-400">3+</div>
            <div className="text-gray-600 dark:text-gray-400 mt-2">Giải thưởng</div>
          </div>
        </motion.div>
      </section>
      ...
      <section className="py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { title: 'Giới thiệu', desc: 'Tìm hiểu về hành trình và đam mê của tôi', icon: '👤', path: '/about' },
            { title: 'Dự án', desc: 'Khám phá các dự án tôi đã thực hiện', icon: '🚀', path: '/projects' },
            { title: 'Kỹ năng', desc: 'Xem các công nghệ tôi thành thạo', icon: '💼', path: '/skills' },
            { title: 'Học vấn', desc: 'Quá trình học tập và phát triển', icon: '🎓', path: '/education' },
            { title: 'Chứng chỉ', desc: 'Các chứng chỉ và thành tựu', icon: '📜', path: '/certificates' },
            { title: 'Liên hệ', desc: 'Hãy kết nối và làm việc cùng nhau', icon: '📧', path: '/contact' },
          ].map((item, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
